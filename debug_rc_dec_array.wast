...
(memory 10000)
  ...
  (func $make_new_block (param $here i32) (param $size i32) (result i32)
        ...
        (block $exit
               (loop $loop
                     (call $print_i32 (i32.const 5555555))
                    (call $print_i32 (get_local $offset))
                    (call $print_i32 (get_local $size))
                    (call $print_i32 (i32.add (i32.add (get_local $here) (get_global $HEAD_SIZE)) (get_local $offset)))
                    (br_if $exit (i32.eq (get_local $offset) (get_local $size)))
                    (i32.store (i32.add (i32.add (get_local $here) (get_global $HEAD_SIZE)) (get_local $offset)) (i32.const 0))
  ...
  (func $gc_decrease_rc_dfs (param $here i32)
        ...
        (if (call $gc_is_value (get_local $here))
          (then
            (call $print_i32 (i32.const 888888))
            (nop))
          (else
            (block $exit
                   (loop $loop
                         ...
                         (call $print_i32 (i32.load (i32.add (get_global $GC_HEAD_SIZE) (i32.add (get_local $offset) (get_local $here)))))
                         (call $print_i32 (i32.sub (i32.load (i32.add (get_global $GC_HEAD_SIZE) (i32.add (get_local $offset) (get_local $here)))) (get_global $GC_HEAD_SIZE)))
  ...
  (func $gc_decrease_rc (param $here i32)
        (call $print_i32 (i32.const 1919191919))
        (call $print_i32 (get_local $here))
...
(i32.const 0)
(i32.store)
(call $print_i32 (i32.const 12345678))
(get_local $val_b_1)
(call $gc_decrease_rc)
(call $print_i32 (i32.const 12345678))
(get_local $val_a_0)
